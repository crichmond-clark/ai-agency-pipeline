...
export const WorkflowRuns: CollectionConfig = {
  ...
  fields: [
    { name: 'operation', type: 'select', options: ['csv_import', 'profile_generation', 'demo_content_generation', 'demo_site_creation', 'screenshot_capture', 'qa_checks', 'outreach_generation', 'outreach_send'], required: true },
